...
@XmlType(name = "SkillType", namespace = "http://skill-tracker.com/skill-tracker-api-models", propOrder = {
    "skill",
    "level"
})
@XmlRootElement(name = "skill", namespace = "http://skill-tracker.com/skill-tracker-api-models")
public class Skill {
